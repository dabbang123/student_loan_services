...
public class LoanApplicationBL implements ILoanApplicationBL 
{
	...
	public String withdrawApplication (Map<String, Object> userValues)
	{
		...
		return applicationStatusContext.updateLoanApplicationStatus(Integer.parseInt(Objects.toString(userValues.get(LoanApplicationConstants.APPLICATION_ID)))) == 1 ? LoanApplicationConstants.LOAN_APPLICATION_WITHDRAWN : LoanApplicationConstants.LOAN_APPLICATION_WITHDRAW_FAILED;
	}
