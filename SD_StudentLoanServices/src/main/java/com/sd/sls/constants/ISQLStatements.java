...
public class ISQLStatements {
	...
	public static final String GET_ALL_APPROVED_APPLICATIONS = "SELECT APPLICATION_ID, APPLICANT_ID, GUARANTOR_NAME, APPLICATION_DATE, APPLICATION_STATUS, LOAN_AMOUNT, PURPOSE, ASSIGNEE_ID FROM LOAN_APPLICATION WHERE APPLICATION_STATUS = 'A'";
	...
	public static final String GET_ALL_LOAN_OFFERS = "SELECT OFFER_ID AS \"OfferID\", APPLICATION_ID, SANCTIONED_AMOUNT AS \"sanctionedAmount\", INTEREST_RATE AS \"interestRate\", OFFER_STATUS AS \"loanOfferStatus\", DISBURSED_DATE \"disbursedDate\" FROM LOAN_OFFER";
