...
// Update the Application with the Assignee Id and Application Status - RB  	
	@Override
	public int assignApplication(Map<String, Object> userValues)
	{
		return jdbcTemplate.update(ISQLStatements.ASSIGN_APPLICATION, new Object[] {Objects.toString(userValues.get(BankRepresentativeConstants.ASSIGNEE_ID)), ApplicationStatus.valueOf(Objects.toString(userValues.get(BankRepresentativeConstants.APPLICATION_STATUS))).getStatus(), Objects.toString(userValues.get(BankRepresentativeConstants.APPLICATION_ID))});		
	}
}
